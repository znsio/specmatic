...
interface GenerationStrategies {
    ...
    fun generatedPatternsForGenerativeTestsR(resolver: Resolver, pattern: Pattern, key: String): Sequence<ReturnValue<Pattern>>
    ...
    fun generateHttpRequestBodiesR(resolver: Resolver, body: Pattern, row: Row, requestBodyAsIs: Pattern, value: Value): Sequence<ReturnValue<Pattern>>
    fun generateHttpRequestBodiesR(resolver: Resolver, body: Pattern, row: Row): Sequence<ReturnValue<Pattern>>
