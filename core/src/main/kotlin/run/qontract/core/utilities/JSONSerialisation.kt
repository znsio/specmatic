...
//@OptIn(ionSerializer::class, UnstableDefault::class)
...
internal fun prettifyJsonString(content: String): String = indentedJson.encodeToString(lenientJson.parseToJsonElement(content))
