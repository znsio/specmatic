    ...
    fun `qualified simple element in request body`(elementFormDefault: String, form: String) {
        val wsdlContent = """
            <wsdl:definitions xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/"
                              ...
                              targetNamespace="http://specmatic.in/SOAPService/">
                <wsdl:types>
                    <xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema" $elementFormDefault targetNamespace="http://specmatic.in/SOAPService/">
        ...
        val expectedGherkin = """
            Feature: simpleService
                ...
                Scenario: SimpleOperation
                    ...
                    And response-body
                    ""${'"'}
                    <soapenv:Envelope xmlns:SOAPService="http://specmatic.in/SOAPService/" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema"><soapenv:Header specmatic_occurs="optional"/><soapenv:Body><SOAPService:SimpleResponse>(string)</SOAPService:SimpleResponse></soapenv:Body></soapenv:Envelope>
                    ""${'"'}
        """.trimIndent().trim()
