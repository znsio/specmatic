...
import `in`.specmatic.conversions.EnvironmentConfiguration
...
fun parseContractFileToFeature(contractPath: String, hook: Hook = PassThroughHook(), sourceProvider:String? = null, sourceRepository:String? = null, sourceRepositoryBranch:String? = null, specificationPath:String? = null, securityConfiguration: SecurityConfiguration? = null, environmentConfiguration: EnvironmentConfiguration = RealEnvironmentConfiguration()): Feature {
    return parseContractFileToFeature(File(contractPath), hook, sourceProvider, sourceRepository, sourceRepositoryBranch, specificationPath, securityConfiguration, environmentConfiguration)
}
