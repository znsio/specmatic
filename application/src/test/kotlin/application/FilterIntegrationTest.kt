...
//                Arguments.of("PATH='/findAvailableProducts' && EXAMPLE_NAME='SUCCESS' && STATUS='2xx'", 1),
                ...
                Arguments.of("PATH='/findAvailableProducts' && HEADERS='request-id' && STATUS!='4xx' && STATUS!='5xx'", 1),
                Arguments.of("PATH='/findAvailableProducts' && HEADERS!='request-id' && STATUS!='4xx' && STATUS!='5xx'", 0),
            )
        }
