...
@CommandLine.Command(name = "qontract", mixinStandardHelpOptions = true, version = ["0.4.2"], subcommands = [CheckCommand::class, CheckoutCommand::class, CompareCommand::class, HelpCommand::class, IncrementCommand::class, ListCommand::class, MockCommand::class, RepoCommand::class, SamplesCommand::class, ShowCommand::class, StubCommand::class, TestCommand::class, UpdateCommand::class])
