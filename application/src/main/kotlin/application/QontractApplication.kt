...
@Command(name = "qontract", mixinStandardHelpOptions = true, versionProvider = VersionProvider::class, subcommands = [BackwardCompatibleCommand::class, CompareCommand::class, SamplesCommand::class, StubCommand::class, ImportCommand::class, TestCommand::class, VersionCommand::class])
