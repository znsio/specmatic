...
class ExampleExternalisationModuleTest {

    private val exampleExternalisationModule = ExampleExternalisationModule(ExampleModule())

    @BeforeEach
    fun resetCounter() {
        exampleExternalisationModule.resetExampleFileNameCounter()
    }
    ...
    fun `should externalise the inline examples into an examples folder`() {
        ...
        try {
            ...
            examplesDir = exampleExternalisationModule.externaliseInlineExamples(contractFile)
